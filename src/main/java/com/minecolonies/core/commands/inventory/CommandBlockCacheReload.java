...
public class CommandBlockCacheReload implements IMCColonyOfficerCommand
{
    ...
    public int onExecute(CommandContext<CommandSourceStack> context)
    {
        ...
        {
            building.getBuilding().reloadCache();
        }

        if (blockEntity instanceof IInventory inventory)
        {
