...
public class CommandCitizenCachePrint implements IMCColonyOfficerCommand
{
    ...
    public int onExecute(CommandContext<CommandSourceStack> context)
    {
        ...
        final String debugString = entityCitizen.getInventory().getCacheDebugString();
